      ...
      {selectedSubject && (
        <div className="flex justify-center mt-8">
          <Link href={`/quiz?subject=${selectedSubject}`}>
            <button className="px-10 py-5 bg-gradient-to-r from-pink-500 to-indigo-500 rounded-lg text-lg font-medium shadow-lg transform transition-all duration-300 hover:scale-110 hover:rotate-6 focus:outline-none focus:ring-4 focus:ring-pink-500">
              Start Quiz
            </button>
          </Link>
        </div>
